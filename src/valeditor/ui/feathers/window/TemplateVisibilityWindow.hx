...
import valeditor.editor.visibility.TemplateValueVisibility;
 ...
 * @author Matse
 */
class TemplateVisibilityWindow extends Panel 
{
	public var cancelCallback(get, set):Void->Void;
	public var confirmCallback(get, set):Void->Void;
	public var title(get, set):String;
	public var visibilityCollection(get, set):TemplateVisibilityCollection;
	...
	private var _visibilityCollection:TemplateVisibilityCollection;
	private function get_visibilityCollection():TemplateVisibilityCollection { return this._visibilityCollection; }
	private function set_visibilityCollection(value:TemplateVisibilityCollection):TemplateVisibilityCollection
	{
	...
	private function get_visibilityCollectionDefault():TemplateVisibilityCollection { return this._visibilityCollection; }
	...
	private var _gridCollection:ArrayCollection<TemplateValueVisibility>;
	
	private var _editCollection:TemplateVisibilityCollection;
	
	public function new() 
	{
		super();
		this._editCollection = TemplateVisibilityCollection.fromPool();
		this._gridCollection = new ArrayCollection<TemplateValueVisibility>(this._editCollection.valueList);
	}
