...
class IntRangeUI extends ValueUI 
{
	...
	**/
	...
	{
		if (!this._intRange.liveTyping) return;
	...
	private function onValueChangeBegin(evt:ValueUIEvent):Void
	{
		...
		if (this._action != null)
		{
			throw new Error("IntRangeUI ::: action should be null");
		}
	...
	private function onValueChangeEnd(evt:ValueUIEvent):Void
	{
		...
		if (this._action == null)
		{
			throw new Error("IntRangeUI ::: action should not be null");
		}
