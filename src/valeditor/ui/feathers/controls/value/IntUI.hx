...
{
	static private var _POOL:Array<IntUI> = new Array<IntUI>();
	...
	static public function fromPool():IntUI
	{
	...
	**/
	...
	private function onValueChangeBegin(evt:ValueUIEvent):Void
	{
		...
		if (this._action != null)
		{
			throw new Error("IntUI ::: action should be null");
		}
	...
	private function onValueChangeEnd(evt:ValueUIEvent):Void
	{
		...
		if (this._action == null)
		{
			throw new Error("IntUI ::: action should not be null");
		}
