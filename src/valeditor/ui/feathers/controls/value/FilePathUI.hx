...
class FilePathUI extends ValueUI 
{
	...
	{
		this._fileSelector.start(this.onFileSelected, this.onFileCancelled, this._filePathValue.fileMustExist, this._filePathValue.fileFilters, this._filePathValue.dialogTitle);
	}
