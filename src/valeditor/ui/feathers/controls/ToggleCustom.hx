 ...
 */
@:styleContext
class ToggleCustom extends LayoutGroup implements IToggle implements IStateContext<ToggleButtonState>
{
	...
	**/
	public function new(?text:String, ?changeListener:(Event)->Void) 
	{
		super();
