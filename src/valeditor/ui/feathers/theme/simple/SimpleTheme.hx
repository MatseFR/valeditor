...
import valeditor.ui.feathers.theme.simple.components.DividedBoxStyles;
...
import valeditor.ui.feathers.theme.simple.components.TextAreaStyles;
...
class SimpleTheme extends ClassVariantTheme implements IDarkModeTheme implements IChangeUpdate
{
	...
	public function new(lightThemeColor:Int = 0x96B4E1, darkThemeColor:Int = 0x4f6f9f) 
	{
		...
		DividedBoxStyles.initialize(this, this.styleProvider);
		...
		TextAreaStyles.initialize(this, this.styleProvider);
