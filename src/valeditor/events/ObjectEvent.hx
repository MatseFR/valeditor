...
class ObjectEvent extends Event 
{
	...
	static public function dispatch(dispatcher:IEventDispatcher, type:String, object:ValEditObject,
	...
	public function setTo(type:String, object:ValEditObject, bubbles:Bool = false, cancelable:Bool = false):ObjectEvent
	{
		this.type = type;
		this.object = object;
