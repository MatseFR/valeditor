 ...
 * @author Matse
 */
class LayerOpenFLEditable extends EventDispatcher implements ITimeLineLayerEditable implements ILayerOpenFLEditable
{
	static private var _POOL:Array<LayerOpenFLEditable> = new Array<LayerOpenFLEditable>();
	
	static public function fromPool():LayerOpenFLEditable
	{
	...
	private function set_locked(value:Bool):Bool
	{
		...
		this._displayContainer.mouseEnabled = !value;
		this._locked = value;
	...
	private function set_visible(value:Bool):Bool
	{
		...
		this._displayContainer.visible = value;
		this._visible = value;
