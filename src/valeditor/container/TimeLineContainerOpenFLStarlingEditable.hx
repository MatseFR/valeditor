...
import valeditor.container.ILayerOpenFLEditable;
import valeditor.container.ILayerStarlingEditable;
 ...
 * @author Matse
 */
class TimeLineContainerOpenFLStarlingEditable extends EventDispatcher implements IContainerEditable implements ITimeLineContainerEditable implements IContainerOpenFLEditable implements IContainerStarlingEditable
{
	static private var _POOL:Array<TimeLineContainerOpenFLStarlingEditable> = new Array<TimeLineContainerOpenFLStarlingEditable>();
	
	static public function create():TimeLineContainerOpenFLStarlingEditable
	{
		var container:TimeLineContainerOpenFLStarlingEditable = fromPool();
		ValEditor.setupTimeLineContainer(container);
		return container;
	}
	
	static public function fromPool():TimeLineContainerOpenFLStarlingEditable
	{
		if (_POOL.length != 0) return _POOL.pop();
		return new TimeLineContainerOpenFLStarlingEditable();
	}
	...
	{
		return LayerOpenFLStarlingEditable.fromPool();
	}
	...
	private function layerRegister(layer:ITimeLineLayerEditable, index:Int):Void 
	{
		...
		cast(layer, ILayerOpenFLEditable).rootContainer = this._container;
	...
	private function layerUnregister(layer:ITimeLineLayerEditable):Void 
	{
		...
		cast(layer, ILayerOpenFLEditable).rootContainer = null;
	...
	public function cloneTo(container:TimeLineContainerOpenFLStarlingEditable):Void
	{
