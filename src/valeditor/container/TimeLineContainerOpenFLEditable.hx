 ...
 * @author Matse
 */
class TimeLineContainerOpenFLEditable extends EventDispatcher implements IContainerEditable implements ITimeLineContainerEditable implements IContainerOpenFLEditable
{
	static private var _POOL:Array<TimeLineContainerOpenFLEditable> = new Array<TimeLineContainerOpenFLEditable>();
	
	static public function create():TimeLineContainerOpenFLEditable
	{
		var container:TimeLineContainerOpenFLEditable = fromPool();
		ValEditor.setupTimeLineContainer(container);
		return container;
	}
	
	static public function fromPool():TimeLineContainerOpenFLEditable
	{
		if (_POOL.length != 0) return _POOL.pop();
		return new TimeLineContainerOpenFLEditable();
	}
	...
	{
		return this._container.visible = this.containerUI.visible = value;
	}
	...
	{
		return LayerOpenFLEditable.fromPool();
	}
