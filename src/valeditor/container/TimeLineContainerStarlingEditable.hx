 ...
 * @author Matse
 */
class TimeLineContainerStarlingEditable extends EventDispatcher implements IContainerEditable implements ITimeLineContainerEditable implements IContainerStarlingEditable
{
	static private var _POOL:Array<TimeLineContainerStarlingEditable> = new Array<TimeLineContainerStarlingEditable>();
	
	static public function create():TimeLineContainerStarlingEditable
	{
		var container:TimeLineContainerStarlingEditable = fromPool();
		ValEditor.setupTimeLineContainer(container);
		return container;
	}
	
	static public function fromPool():TimeLineContainerStarlingEditable
	{
		if (_POOL.length != 0) return _POOL.pop();
		return new TimeLineContainerStarlingEditable();
	}
	...
	private var _containerStarling:Sprite = new Sprite();
	...
	public function cloneTo(container:TimeLineContainerStarlingEditable):Void
	{
