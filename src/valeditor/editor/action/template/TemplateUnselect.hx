 ...
 * @author Matse
 */
class TemplateUnselect extends ValEditorAction 
{
	static private var _POOL:Array<TemplateUnselect> = new Array<TemplateUnselect>();
	
	static public function fromPool():TemplateUnselect
	{
	...
	public function apply():Void
	{
		...
		{
			throw new Error("TemplateUnselect already applied");
		}
	...
	public function cancel():Void
	{
		...
		{
			throw new Error("TemplateUnselect already cancelled");
		}
